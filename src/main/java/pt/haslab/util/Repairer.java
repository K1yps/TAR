...
public class Repairer {
    ...
    public final CompModule module;
    ...
    private Repairer(CompModule module, Command command, ArrayList<Func> repairTargets) {
        this.module = module;
        this.command = command;
        this.repairTargets = repairTargets;
    }

    public static Repairer make(CompModule module, Command command, Collection<Func> repairTargets, int maxDepth) {
    ...
    public static class CounterExample {
        ...
        public String toString() {
            return String.valueOf(ocurrences);
        }
        ...
        public Expr getOracleExpr(Repairer repairer) {
            ...
            if (!(expr instanceof ExprBinary command)) {
                return null;
            }
